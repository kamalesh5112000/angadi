(function ($) {
    ...
    martfury.addWishlist = function () {
        ...
        martfury.$body.on('added_to_wishlist removed_from_wishlist cart_page_refreshed', function () {
            ...
            var ajax_url = wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'update_wishlist_count');
    ...
    martfury.fbtAddToCartAjax = function () {
        ...
        $fbtProducts.on('click', '.mf_add_to_cart_button.ajax_add_to_cart', function (e) {
            ...
            var data = {
                ...
                ajax_url = wc_add_to_cart_params.wc_ajax_url.toString().replace('%%endpoint%%', 'martfury_fbt_add_to_cart');
