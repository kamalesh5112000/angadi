...
function add_my_script() {
    wp_enqueue_script(
        'user_custom', // name your script so that you can attach other scripts and de-register, etc.
        get_template_directory_uri() . '/js/user_custom.js', // this is the location of your script file
